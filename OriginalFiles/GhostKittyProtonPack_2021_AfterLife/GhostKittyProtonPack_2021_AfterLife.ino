...
// --- Bar Graph Type ---
// Please uncomment the line that matches your hardware.
// The library was originally written for COMMON_ANODE.

#define BARGRAPH_TYPE COMMON_ANODE
// #define BARGRAPH_TYPE COMMON_CATHODE
