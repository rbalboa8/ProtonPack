...
/*********************************************************
    Include for File to edit for user options
 *********************************************************/
...
// Vent + Wand LED Count
const int NeoPixelLEDCount2 = 13;
...
void setup() {
  ...
  BarGraph.BGSeq(BARGRAPH_HARDWARE);    // Initiaze the BarGraph | Now includes ability to define user hardware, Common Anode(default/Common Cathode)  
